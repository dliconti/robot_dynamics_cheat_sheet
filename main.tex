...
\begin{multicols*}{4}
	...
	$\displaystyle M  = \sum_{i=1}^{n_b}\left({}_\mathcal{A}J_{S_i}^T\cdot m\cdot  {}_\mathcal{A}J_{S_i}+{}_\mathcal{B}J_{R_i}^T\cdot{}_\mathcal{B}\Theta_{S_i}\cdot {}_\mathcal{B}J_{R_i}\right)$\\
